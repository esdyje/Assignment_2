...
setwd("~/OneDrive - Aarhus universitet/AU-Cognitive Science/3rd Semester/Experimental Methods 3/Exercise/Assignments/Schiz proj part 2")
...
model=glmer(Diagnosis~range+(1+Trial|Subject),data,family="binomial")
summary(model)
#inverting
exp(0.2699) #1.3% er schizo/typ, rest

Celine=read.csv("final_rqa.csv")
length(Celine,diagnosis)
#1.2
...
######Crossvalidating
```{r setup, include=FALSE}
newData=newData[complete.cases(newData$DET),]
