...
Stud2Mean=mean(Stud2$f0)
Stud2SD=sd(Stud2$f0)
Stud2range=range(Stud2$f0)

#less standard descriptors
Stud2median=median(Stud2$f0)
Stud2IQR=IQR(Stud2$f0)
Stud2MAD=aad(Stud2$f0)
Stud2CV=(Stud2SD/Stud2Mean)*100

par = list(lgM =  50, steps = seq(1, 6, 1),  radiusspan = 100,  radiussample = 40, normalize = 0,  rescale = 0,  mindiagline = 2,  minvertline = 2,  tw = 0,  whiteline = FALSE,  recpt = FALSE,  fnnpercent = 10,  typeami = "mindip")
ans = optimizeParam(Stud2$f0, Stud2$f0, par, min.rec = 3.5, max.rec = 4.5)

#results
Results=crqa (Stud2$f0, Stud2$f0, delay=ans$delay, embed=ans$emddim, radius=ans$radius,normalize=0,rescale=0,mindiagline = 2,minvertline = 2)
#plotting
RP=Results$RP
