...
mean(MeanResults$AUC) # 0.55
mean(MedianResults$AUC) # 0.56
mean(RRresults$AUC)# 0.51
mean(ENTRresults$AUC) # 0.60
...
mean(combination1$AUC) # mean AUC(.63)
mean(combination2$AUC) # mean AUC(.63)
mean(combination3$AUC) # mean AUC(.63)
mean(combination4$AUC) # mean AUC(.64)
mean(combination5$AUC) # mean AUC(.59)
mean(combination6$AUC) # mean AUC(.60)
mean(combination7$AUC) # mean AUC(.63)
